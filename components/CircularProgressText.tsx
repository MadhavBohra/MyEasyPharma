...
const CircularProgressBarText = ({ 
  ...
  return (
    <View style={{ position: 'relative', width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
      ...
      >
        <Text style={{ fontSize: 32, fontWeight: 'bold', color: `${textcolor}` }}>{textnumber}</Text>
        <Text style={{ fontSize: 25, fontWeight: 'bold', color: `${textcolor}` }}>{textunit}</Text>
      </View>
    </View>
  );
};

export default CircularProgressBarText;
